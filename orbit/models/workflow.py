...
class TaskBase(SQLModel):
    ...
    action_payload: dict = Field(default_factory=dict, sa_column=Column(JSONB))
    dependencies: List[str] = Field(default_factory=list, sa_column=Column(JSONB)) # List of task names this task depends on
